# SamaLtda-borrador
Contrucción de un pequeño bosquejo para plataforma y web page de la empresa SAMA Ltda.

Bosquejo de la página web para la empresa **SAMA Ltda.**, dedicada a la producción y comercialización de sal industrial y de consumo.
...
No requiere instalación. Solo abre `index.html` en tu navegador. Para editar o ampliar el sitio, modifica los archivos HTML y CSS según tus necesidades.
...
- Diseño y desarrollo: Fidian Peralta López
- © 2026 SAMA Ltda. – Todos los derechos reservados.
